                    ...
                    <tr>
                        ...
                        <td>
                            @if($setting->poll_tab == $poll->id)
                                <a data-toggle="tooltip" data-theme="dark" title="Close this poll tab" href="{{route('dashboard.setting.open_poll', 0)}}" class="btn btn-info font-weight-bolder">
                                    <i class="fa fa-door-closed"></i>
                                </a>
                            @else
                                <a data-toggle="tooltip" data-theme="dark" title="Open this poll tab" href="{{route('dashboard.setting.open_poll', $poll->id)}}" class="btn btn-info font-weight-bolder">
                                    <i class="fa fa-door-open"></i>
                                </a>
                            @endif
                                <a href="{{route('dashboard.poll.show', $poll->id)}}">
                                    <button data-toggle="tooltip" data-theme="dark" title="Results" class="btn btn-sm btn-icon btn-success">
                                        <i class="fa fa-tasks"></i>
                                    </button>
                                </a>

                            <a data-toggle="tooltip" data-theme="dark" title="Edit" href="{{route('dashboard.poll.edit', $poll->id)}}" class="btn btn-sm btn-icon btn-primary">
                                <i class="fa fa-pen"></i>
                            </a>
