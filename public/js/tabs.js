  ...
  methods: {
    loadData: function loadData() {
      ...
      axios.get('/settings').then(function (res) {
        if (res.data.poll_tab && _this2.settings.poll_tab != res.data.poll_tab) {
          _this2.$toasted.show('The speaker opened the poll tab');

          document.getElementById('poll_button').click();
        } else if (res.data.question_tab && _this2.settings.question_tab != res.data.question_tab) {
          _this2.$toasted.show('The speaker opened the question tab');
...
/***/ 2:
/*!************************************!*\
  !*** multi ./resources/js/tabs.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\projects\web\Webinar\resources\js\tabs.js */"./resources/js/tabs.js");
